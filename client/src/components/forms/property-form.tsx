...
export default function PropertyForm({ entities, onSubmit, onCancel, isLoading, initialData }: PropertyFormProps) {
  ...
  const form = useForm<z.infer<typeof propertySchema>>({
    ...
    defaultValues: {
      ...
      defaultUnit: {
        label: initialData?.defaultUnit?.label || "Main Unit",
        bedrooms: initialData?.defaultUnit?.bedrooms,
        bathrooms: initialData?.defaultUnit?.bathrooms,
        sqft: initialData?.defaultUnit?.sqft,
        rentAmount: initialData?.defaultUnit?.rentAmount || "",
        deposit: initialData?.defaultUnit?.deposit || "",
        notes: initialData?.defaultUnit?.notes || "",
        hvacBrand: initialData?.defaultUnit?.hvacBrand || "",
        hvacModel: initialData?.defaultUnit?.hvacModel || "",
        hvacYear: initialData?.defaultUnit?.hvacYear,
        hvacLifetime: initialData?.defaultUnit?.hvacLifetime,
        hvacReminder: initialData?.defaultUnit?.hvacReminder || false,
        waterHeaterBrand: initialData?.defaultUnit?.waterHeaterBrand || "",
        waterHeaterModel: initialData?.defaultUnit?.waterHeaterModel || "",
        waterHeaterYear: initialData?.defaultUnit?.waterHeaterYear,
        waterHeaterLifetime: initialData?.defaultUnit?.waterHeaterLifetime,
        waterHeaterReminder: initialData?.defaultUnit?.waterHeaterReminder || false,
