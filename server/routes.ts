  ...
  app.post('/api/expenses', isAuthenticated, async (req: any, res) => {
    try {
      ...
      const cleanedData = {
        ...
        recurringEndDate: req.body.recurringEndDate ? (typeof req.body.recurringEndDate === 'string' ? req.body.recurringEndDate : req.body.recurringEndDate.toISOString()) : undefined,
        ...
        amortizationStartDate: req.body.amortizationStartDate ? (typeof req.body.amortizationStartDate === 'string' ? req.body.amortizationStartDate : req.body.amortizationStartDate.toISOString()) : undefined,
